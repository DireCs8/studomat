...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  mail($to,"[Recruiter] Kontaktný formulár",
       "Meno: $name\nPriezvisko: $surname\nFirma: $org\nEmail: $email\n\n$msg",
       "From:$email");
...
<div class="container">
  ...
  <?php else: ?>
    <h3>Recruiter – Kontaktný formulár</h3>
    <form method="POST">
      ...
      <div class="form-group">
        <label>Firma</label><input class="form-control" name="organization" required>
      </div>
      <div class="form-group">
      ...
      <button class="btn btn-primary" name="submit_recruiter">Odoslať</button>
    </form>
